    ...
    return (
      <nav className="nav__container">
        <div className="nav__return">
          <a className="nav__button-return" onClick={this.props.onBackClick} src="#">
          <svg className="nav__arrow-return-svg" width="8" height="10" viewBox="0 0 8 10">
              <path fill="#CCAC5B" fillRule="evenodd" d="M7.357 0v10L0 5z"/>
          </svg>
            <p className="nav__return-text"> go back</p>
         </a>
        </div>
        <div className="nav__body">
          <a href="#" className="nav__company-logo">
            <svg className="nav__company-logo-svg" width="590" height="73" viewBox="0 0 590 73">
